...
public class ChatActivity extends Activity {
	...
	private String LOG_TAG = "Hookup_ChatActivity";
	...
	protected Dialog onCreateDialog(int id) {
		...
		if (id == PVT_CHAT) {
			...
			return new AlertDialog.Builder(ChatActivity.this).setTitle(
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		bindService(new Intent(ChatActivity.this, ServiceIRCService.class),
		...
		if (target.startsWith("#")) {
			temptitle = target.replaceFirst("#", "");
		}
		setTitle("Chat >> " + temptitle);
	...
	private void sendText(String msg) {
		if (msg != null && !msg.equalsIgnoreCase("")) {
			ServiceIRCService.sendToChan(msg.trim());
		}
	}
